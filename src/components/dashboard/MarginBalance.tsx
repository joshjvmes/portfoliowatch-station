        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="text-4xl font-bold text-white">
              {showBalances ? "59,977.3129" : "****"} <span className="text-gray-400">USD</span>
            </div>
            <div className="flex items-center gap-2 text-gray-400 mt-1">
              {showBalances ? "≈ $59,977.31" : "≈ $****"} / Today's Realized PnL {showBalances ? "$0.00 (+0.00%)" : "$****"} <ChevronRight className="h-4 w-4" />
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center">
              ...
              <span className="text-green-400 ml-2">{showBalances ? "999.99" : "****"}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8">
            <div>
              ...
              <div className="text-xl font-semibold text-white">{showBalances ? "59,853.3433" : "****"}</div>
              <div className="text-gray-400">{showBalances ? "≈ $59,853.34" : "≈ $****"}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-xl font-semibold text-white">{showBalances ? "0.0000" : "****"}</div>
              <div className="text-gray-400">{showBalances ? "≈ $0.00" : "≈ $****"}</div>
            </div>
          </div>
